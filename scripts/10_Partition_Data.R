...
# 3. Creación de la partición (Holdout 80/20)
...
formula_xgb <- as.formula(paste("economy_f ~ totalPrice + log_price +", paste(pred_base, collapse = " + ")))
...
save(train_df, test_df, X_train_xgb, X_test_xgb, y_train_xgb, y_test_xgb, pred_base,
